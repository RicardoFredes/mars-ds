...
const IconExpand = ({ height = 24, width = 24 }: IconLibProps) => {
  return (
    ...
    >
      <path
        d="M20 5C20 4.44772 19.5523 4 19 4H14C13.4477 4 13 4.44772 13 5C13 5.55228 13.4477 6 14 6H16.57L13.29 9.29C13.1007 9.47777 12.9942 9.73336 12.9942 10C12.9942 10.2666 13.1007 10.5222 13.29 10.71C13.4778 10.8993 13.7334 11.0058 14 11.0058C14.2666 11.0058 14.5222 10.8993 14.71 10.71L18 7.42V10C18 10.5523 18.4477 11 19 11C19.5523 11 20 10.5523 20 10V5Z"
        fill="currentColor"
      />
      <path
